...
import static xute.markdeditor.styles.TextModeType.MODE_OL;
import static xute.markdeditor.styles.TextModeType.MODE_PLAIN;
...
public class MainActivity extends AppCompatActivity implements EditorControlBar.EditorControlListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markDEditor.loadDraft(DummyPublishingData.getDraftContent());
